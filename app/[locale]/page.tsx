...
export default async function HomePage() {
  ...
  const categories = [
    { key: 'appetizer', label: t('menu.appetizers'), icon: '🥗', iconImageUrl: 'https://github.com/Dafi-web/digital-menu-list/blob/master/photo_2025-04-07%2018.03.24.jpeg?raw=true', color: 'from-green-500 via-emerald-500 to-teal-500', bgColor: 'from-green-50 to-emerald-50', textColor: 'text-green-700', borderColor: 'border-green-300' },
