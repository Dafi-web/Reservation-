...
export default async function HomePage() {
  ...
  const categories = [
    { key: 'appetizer', label: t('menu.appetizers'), icon: '🥗', color: 'from-green-600 to-emerald-700' },
    { key: 'main', label: t('menu.mainCourses'), icon: '🍽️', color: 'from-amber-600 to-orange-700' },
    { key: 'dessert', label: t('menu.desserts'), icon: '🍰', color: 'from-amber-500 to-red-600' },
    { key: 'beverage', label: t('menu.beverages'), icon: '☕', color: 'from-amber-700 to-yellow-600' },
  ...
  return (
    <div className="min-h-screen overflow-hidden">
      ...
      <section className="relative bg-gradient-to-br from-amber-900/95 via-orange-900/95 to-red-900/95 py-32 lg:py-40 overflow-hidden">
        {/* Overlay Pattern */}
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-10 w-96 h-96 bg-amber-600/20 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-float"></div>
          <div className="absolute top-40 right-10 w-96 h-96 bg-orange-700/20 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-float" style={{ animationDelay: '2s' }}></div>
          <div className="absolute -bottom-8 left-1/2 w-96 h-96 bg-red-800/20 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-float" style={{ animationDelay: '4s' }}></div>
        </div>
