...
export default async function HomePage() {
  ...
  const categories = [
    ...
    { key: 'main', label: t('menu.mainCourses'), icon: '🍽️', color: 'from-red-600 via-amber-600 to-stone-700', bgColor: 'from-red-50 to-stone-50', textColor: 'text-red-700', borderColor: 'border-red-300' },
    ...
    { key: 'beverage', label: t('menu.beverages'), icon: '☕', color: 'from-amber-700 via-amber-600 to-stone-600', bgColor: 'from-amber-50 to-stone-50', textColor: 'text-amber-800', borderColor: 'border-amber-300' },
