...
/** Admin receives new-reservation emails. Override in Vercel with ADMIN_EMAIL env var. */
const ADMIN_EMAIL = process.env.ADMIN_EMAIL?.trim() || 'ristoranteafrica88@gmail.com';
