...
export default function Navigation() {
  ...
  return (
    <nav className="glass-effect shadow-elegant sticky top-0 z-50 border-b border-amber-100/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center space-x-12">
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-amber-400 to-orange-500 rounded-2xl blur-lg opacity-40 group-hover:opacity-60 transition-opacity duration-300"></div>
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 relative overflow-hidden ${
                    pathname === link.href 
                      ? 'bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-elegant' 
          ...
          <div className="flex items-center space-x-3">
            ...
            <select
              ...
              value={currentLocale}
              className="px-4 py-2.5 border-2 border-gray-200 rounded-xl text-sm font-semibold text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all cursor-pointer hover:border-amber-300 hover:shadow-elegant"
            >
